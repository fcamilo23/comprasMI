<div class="row col-12">
    <div class="col-lg-6 center">
        ...
        <input type="number" name="sr" class="form-control" value="<?php echo $_SESSION['solicitudActual']['SR']; ?>" style="margin-top: 0px;" placeholder="Ingrese el número SR" required >
        ...
        <select name="estado" class="form-control">
            ...
            <option <?php if ($_SESSION['solicitudActual']['estado'] == "Entregada"){?> selected <?php } ?> value="Entregada" >Entregada</option>
    ...
    <div class="col-lg-6 center">
        ...
        <textarea class="form-control" name="detalle" cols="40" rows="4" style="margin-top: 0px;" placeholder="Ingrese un detalle aquí"><?php echo $_SESSION['solicitudActual']['detalle'] ?></textarea>
