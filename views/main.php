...
<div id="menux1" class="container-menu" style="z-index:2;" >
    <div id="menux" class="cont-menu">
        ...
        <dialog class="" id="modalreportes" style="width: 300px; background: #023763; margin-left: 340px; margin-top: -25px; border: none; border-radius: 0px; padding: 25px;  z-index: 1; animation: createBox .15s; border: none">
